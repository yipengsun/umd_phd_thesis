...
and $\rho_\text{data-driven}$ is a Gaussian constraint to the fixed yield
allowing it to vary with a pre-set uncertainty.
...
Both muonic and tauonic $DDX$ fit templates have large \mSq,
