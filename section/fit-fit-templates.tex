...
\begin{equation}
    N_{\Dz\muon} \times \left\{
        \RDst \times \fitRuDstScale \times \fitRDstEff \times \fitnormfd
    \right\}
\end{equation}
where $\eta_{\Dstarz}$ is defined similarly to $\eta_{\Dstarp}$.

The three efficiency ratios $\fitRDstEff, \eta_{\Dstarp}, \eta_{\Dstarz}$
are fixed in the fit so that \emph{no} correction to these ratios is derived.
