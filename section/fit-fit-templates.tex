...
obtained with MC samples satisfying the \Dz channel selection criteria,
...
``normfd'' is the yield ratio
between the \Dstarz\muon and \Dz\muon samples,
while absorbing the selection efficiency ratio between the two
(the initial value assumes that ratio to be unity).
\begin{equation}
    \text{normfd} =
    \left.\frac{
        \epsilon^\text{sel}(\Bm \rightarrow \Dstarz\mun\neumb)
