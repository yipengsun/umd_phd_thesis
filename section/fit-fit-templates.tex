...
The fit includes the following feed-down templates from 4 $1P$ $D^{**}$ states
$D_0^*(2300)$, $D'_1(2430)$, $D_1(2420)$, $D_2^*(2460)$,
including both isospin pairs for each \Dstst,
with the subscript indicating the total angular spin $J$ of the meson\footnote{
