...
\begin{itemize}
    ...
    \item \textbf{\textcolor{purple}{purple}}:
...
\begin{figure}[!htb]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__m2miss.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__el.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__q2.pdf}
        \caption{
    ...
    \caption{
        Comparison between normalization templates.
    }
