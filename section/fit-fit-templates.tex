...
The \Dstarp\muon template contributes to both fit channels due to feed down,
and its yield in the \Dz channel is normalized as:
\begin{equation}
    N_{D\mu} \times \left\{
        \epsilon_{\Dstar}^\text{isolation} \times \text{normfd}
    \right\}
\end{equation}
where $\epsilon_{\Dstar}^\text{isolation}$ is the relative yield ratio
between the \Dstarp\muon and \Dstarz\muon samples
\begin{equation}
    \epsilon_{\Dstar}^\text{isolation} =
    \left.\frac{
        \epsilon^\text{sel}(\Bzb \rightarrow \Dstarp\mun\neumb)
    }{
        \epsilon^\text{sel}(\Bm \rightarrow \Dstarz\mun\neumb)
...
\Dstarp and neutral \Dstarz events;
the second ratio is the branching fraction ratio from external measurements.
``normfd'' is the yield ratio\footnote{
    This factor is conceptually identical to that of
    $\epsilon_{\Dstar}^\text{isolation}$.
    The naming convention chosen here is for backward compatibility with the
    run 1 pathfinder analysis and easier cross-referencing with the fitter
    source code.
}
between the \Dstarz\muon and \Dz\muon samples
\begin{equation}
    \text{normfd} =
    \left.\frac{
        \epsilon^\text{sel}(\Bm \rightarrow \Dstarz\mun\neumb)
    }{
        \epsilon^\text{sel}(\Bm \rightarrow \Dz\mun\neumb)
...
\begin{equation}
    N_{D\mu} \times \text{normfd}
\end{equation}
A comparison between this template and the normalization template in the \Dz
...
\begin{figure}[!htb]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__vs__Dst_iso_DstMu__m2miss.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__vs__Dst_iso_DstMu__el.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_DstMu__vs__Dst_iso_DstMu__q2.pdf}
        \caption{
            $\textcolor{blue}{\Bm \rightarrow \Dz\mun\neumb}$ vs
            $\textcolor{red}{\Bzb \rightarrow \Dstarp\mun\neumb}$ feed down,
            both in \Dz channel.
            $\textcolor{magenta}{\Bzb \rightarrow \Dstarp\mun\neumb}$
            in \Dstar channel is included as a reference.
        }
    \end{subfigure}

    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_Dst0Mu__m2miss.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_Dst0Mu__el.pdf}
        \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__D0_iso_Dst0Mu__q2.pdf}
        \caption{
            $\textcolor{blue}{\Bm \rightarrow \Dz\mun\neumb}$ vs
            $\textcolor{red}{\Bm \rightarrow \Dstarz\mun\neumb}$ feed down,
            both in \Dz channel.
        }
    \end{subfigure}
    ...
    % \begin{subfigure}{\textwidth}
    %     \centering
    %     \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__Dst_iso_DstMu__m2miss.pdf}
    %     \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__Dst_iso_DstMu__el.pdf}
    %     \includegraphics[width=0.3\textwidth]{figs-fit-fit-templates/histo-comp/D0_iso_D0Mu__vs__Dst_iso_DstMu__q2.pdf}
    %     \caption{
    %         $\textcolor{blue}{\Bm \rightarrow \Dz\mun\neumb}$ in \Dz channel vs
    %         $\textcolor{magenta}{\Bzb \rightarrow \Dstarp\mun\neumb}$
    %         in \Dstar channel.
    %     }
    % \end{subfigure}
...
\end{equation}
is the efficiency ratios between the signal and the normalization
mode.
The efficiencies $\epsilon({\Bm \rightarrow \Dz \ellm \neulb})$ are obtained
with the corresponding MC samples satisfying \Dz selection criteria.

%
\paragraph{$B \rightarrow \Dstarp\taum\neutb$}
The signal template in the \Dstar channel but contributes to both channels
due to feed down.
The \Dz channel yield is given by
\begin{equation}
    N_{\Dz\muon} \times \left\{
        \eta_{\Dstarz} \times \tilde{\eta}_{\Dstarp} \times \RDst \times
        \text{normfd} \times
    \right\}
\end{equation}
