...
The misID templates are generated from the fake \muon control sample
...
\begin{equation}
    ...
    \right\}
\end{equation}
where $\fitfsfd = 2.6$ (the latest measured value is 2.4 at 13~TeV, but 2.6 is
used instead)
...
where $D_q$ represents a generic charm meson with $q$ being a $u$, a $d$, or a
$s$ quark,
and $X$ is a \pion, a \kaon, a \Kstar, or a higher \Kstar resonance.
