...
% Many samples are \emph{cocktails},
% that is, samples that contain a mixture of different simulated decay modes.
% The compositions of the cocktails are either listed explicitly or provided in a
% reference.
