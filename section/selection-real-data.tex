...
vertex is displaced from the $pp$ vertex,
...
requirements on the selected candidates.

Overall, the online selection for \Dz channel requires a \muon candidate to form
a well-defined vertex,
displaced from the $pp$ vertex,
...
Furthermore, only the \Dz\mup, referred as ``right-sign'' combinations, are
kept.
...
these are marked in the tables and will be discussed later.
...
\subsection{Signal (ISO) data sample}
