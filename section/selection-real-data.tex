...
\begin{itemize}
    \item Right-sign samples (\cref{ref:sel:data:rs}):
        the nominal data samples to be fitted.
    \item Wrong-sign samples (\cref{ref:sel:data:ws}):
        ...
        requiring so.
    \item Fake muon samples (\cref{ref:sel:data:fake-mu}):
...
More details about the trigger path is given below.
