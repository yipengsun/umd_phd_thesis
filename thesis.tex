...
% margins
% NOTE: the original way of configuring margins looks like a BAD idea!
...
\usepackage{etoolbox}
% FIXME: The negative vertical gaps are put in by hand!
%        This is because I sometimes left an empty line before 'equation'
