...
%%%%%%%%%%%%
\usepackage{tikz}
\usetikzlibrary{external,quotes,angles,positioning}
...
\setlength{\cftfignumwidth}{\widthof{99.999~}}
...
% allow page breaks inside math envs
\allowdisplaybreaks

% bra-ket
% FIXME: The LHCb style defines an inferior version of these commands. Comment
% them out!!!
...
\usepackage[bottom,hang,flushmargin,splitrule]{footmisc}

% place landscape tables in the immediate next page
...
% circled number w/ tikz
\newcommand\circled[1]{\tikz[baseline=(char.base)]{
        \node[shape=circle,draw,inner sep=2pt] (char) {#1};
}}

% \paragraph with toc
\newcommand\paragraphtoc[1]{\paragraph{#1}\addcontentsline{toc}{section}{#1}}
