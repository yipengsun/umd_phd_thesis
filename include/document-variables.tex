...
\newcommand{\fitisoDi}{\ensuremath{\hat{r}_{\Dstst_i}^\text{isospin}}\xspace}  % e.g. iso_D1
% fit parameters, D0 chan
\newcommand{\fitNDmu}{\ensuremath{N_{D\mu}}\xspace}
\newcommand{\fitRDEff}{\ensuremath{\eta_{\Dz}}\xspace}
\newcommand{\fitNDststDz}{\ensuremath{n^{\Dz}_{\Dstst}}\xspace}  % NDststD0
\newcommand{\fitBFDDi}{\ensuremath{\mathcal{B}_{\Dstst_i}^{\Dz}}}  % e.g. BFDD1
...
\newcommand{\fitnormfd}{\ensuremath{r_{\Dstarz}^\text{\Dz}}\xspace}
