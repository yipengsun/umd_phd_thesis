...
To obtain the true yields $\tilde{n}_t$,
...
\begin{enumerate}[label=\protect\circled{\arabic*}]
    ...
    \item Compute a $\chi^2$ between $N^\pion_0$ and the initial estimated
        ...
        go back to \circled{2} with the $N^\pion_0$ as the estimated true yield,
        instead of $\tilde{n}_\hat{\pion}$.
\end{enumerate}

The key insight to this unfolding approach is:
...
%%%%
Now it is time to find \misEff[\hat{t}']{t}. Recall its definition:
