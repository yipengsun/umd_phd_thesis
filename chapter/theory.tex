...
$V(\phi^\dagger, \phi) =  -\rho^2 \phi^\dagger \phi + \lambda (\phi^\dagger \phi)^2$,
which leads to a non-zero minimum (vacuum expectation value, VEV) of
$v = \sqrt{\frac{\rho^2}{2 \lambda}}$
for $\phi$ degenerate on a complex circle.
...
naive mass terms contain \emph{only} combinations of left-handed particles
...
it is now possible to discuss lepton flavor universality in the SM.
