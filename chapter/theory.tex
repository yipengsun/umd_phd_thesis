...
As an example, each generator of $SU(2)$ can be mapped to a Pauli matrix,
forming a 2 dimensional representation of $SU(2)$.
Denote the $SU(2)$ generators as $\{N_1, N_2, N_3\}$,
...
Since $N_3$ a $n$-dimensional invertible matrix, $2j + 1 = n$.
Hence, such a representation can be labelled with $j = \frac{n - 1}{2}$
which are half-integers.
...
which correspond to specific types of \emph{elementary particle}
of spin $j + j'$:
