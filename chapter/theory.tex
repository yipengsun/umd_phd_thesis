...
to the Lagrangian\footnote{
    ...
    $\mathcal{L} = \bar{\Psi}_e (i \gamma^\mu \fsl{D}_\mu I_{2 \times 2} - M)\Psi_e -
    \frac{1}{4} F_{\mu\nu}F^{\mu\nu}$,
...
of the form
$\Psi_e = \bigl(\begin{smallmatrix} \psi_e \\ \psi_{\neu_e} \end{smallmatrix}\bigr)$,
...
After taking the fact that the 3 generators of $SU(2)$ do not compute into
account,
...
naive mass term cannot be added otherwise the $SU(2)$ gauge symmetry is spoiled.
