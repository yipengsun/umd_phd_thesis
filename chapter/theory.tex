...
Then, all transformations preserving the speed of light can be identified:
rotations, Lorentz boosts, and translations.
Among them the rotation and boost transformations form group called
``Lorentz group''.
...
which preserves direction of space and time\footnote{
    ...
    The other 3 can be obtained by apply parity ($P$), time reversal ($T$),
