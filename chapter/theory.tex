...
plays an central role in this analysis as simulation of these decays
requires an accurate model to generate sensible distributions of fit variables,
most evident in the \qSq distribution.
In this section a brief review of the modelling of these decays is provided.

First, operators that can facilitate $b \rightarrow c \ell \neulb$ are
identified:
