...
\section{Modelling of semileptonic $B \rightarrow D$ decays}

The modelling of semileptonic $B \rightarrow D$ decays,
where $D$ stands for a generic charm meson,
plays an central role in this analysis as it is used in MC simulations to
generate sensible distributions of fit variables, more evident in the \qSq
distribution.
In this section a brief review of the modelling of these decays is provided.

first find the operator

write the matrix elmenet
...
This analysis extensive use of MC simulations with many semileptonic
$B \rightarrow D$ decays.
which require inputs of such decay rates in order to model the corresponding
decay processes.
Different decay rates are reflected on the fit variables,
especially on \qSq.
Therefore, It is very important to model the decay rates accurately.
