...
the electroweak theory, the lepton flavor universality in the SM,
and the full SM.
...
Then, require the Lagrangian to be invariant\footnote{
    Admittedly it is not clear to the author why it has to be the case.
} under certain local transformations
...
makes the transformation $e^{i\alpha(x^\mu)}$ local.
