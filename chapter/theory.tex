...
3 spin 1 particles $W^1, W^2, W^3$ are added to the theory in addition to $B$
which is the only generator of $U(1)$,
because the $SU(2)$ group has 3 generators.
After taking the fact that the 3 generators of $SU(2)$ do not commute into
account,
...
$V(\phi^\dagger, \phi) = \frac{1}{4}\lambda (\phi^\dagger \phi - \frac{1}{2}v^2)$,
which leads to a non-zero minimum (vacuum expectation value, VEV) of $v$
for $\phi^\dagger, \phi$ degenerate on a complex circle.
Write the complex scalar doublet as
...
where $h(x^\mu)$ is a real scalar field.
...
and a non-0 VEV leads to terms of the form $\frac{1}{2}\kappa Z_\mu Z^\mu$ which
...
Furthermore, the weak interaction is experimental shown to maximally violate
parity, that is, the left-handed and right-handed particles are treated
differently.
