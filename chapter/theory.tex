...
it permits addition of arbitrary generations of spin $\frac{1}{2}$ color
singlets (leptons), and each generation couples to all but the Higgs field $h$
with the same strengths through the covariant derivative term.
The LFU is manifested by the very construction of the SM.
They do, however, couples to the Higgs differently in the Yukawa terms which
are realized by their different masses.

The three flavor generations of leptons are purely determined by experiments,
as the SM place no constraint on number of flavor generations.
