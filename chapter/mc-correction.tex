...
To check data/MC agreements on various variables, a post-fit cocktail,
...
termed normalization enriched region,
...
\begin{enumerate}
    ...
    \item After effecting possible variations,
        ...
        template matches the fitted yield in the normalization enriched region.
