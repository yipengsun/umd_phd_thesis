...
between data and MC, the fit for \mmSq now has worse pulls, as can be seen
in \cref{fig:worse-pulls-after-final-rwt}.

% TODO: Use actual plot to show w/o vertex smearing, mm2 has poorer agreements.
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.45\textwidth]{./figs-mc-correction/reweighting-final/plot_step12-Dst_iso-spi_comp.pdf}
    \includegraphics[width=0.45\textwidth]{./figs-mc-correction/reweighting-final/plot_step12-Dst_iso-spi_log_ip_chi2.pdf}
...
- vertex smearing -> change mm2
- degrade ip and ip chi2

one of them cannnot is not fixed in final reweighting included
