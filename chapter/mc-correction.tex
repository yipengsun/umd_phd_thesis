...
values, with the shift of fit variables due to these parameters account for via
an interpolation/extrapolation mechanism\footnote{
...
The change of fit variables with the \emph{shifted} parameters are
