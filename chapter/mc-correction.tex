...
space.
The expansion is in general an approximation, but is exact for the form factor
models used in this analysis, namely BGL and BLR.
...
one notable thing shifted ff due to large alpha, at which point extrapolation
become unphysical. the shifted ff are ploated in.
the original ff are plotted in.
