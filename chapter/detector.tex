...
\begin{itemize}
    \item VErtex LOcator:
        ...
        $1.6 < \eta < 4.9$,
        is a compact 21-layer silicon-strip detector placed closest to the $pp$
        interaction point (10.6~cm downstream)
        \cite{The_LHCb_Collaboration_2008}.
        Each layer of VELO,
        made of two silicon half disks with a pitch\footnote{
        ...
        } ranging from 38 to 102~$\upmu$m (increase with radius),
    ...
    \item T-stations:
        ...
        IT is made of silicon strips whereas OT gas-tight straw-tubes.
