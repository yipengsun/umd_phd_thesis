...
LHCb detector, grouped based on the main utility of
each subdetector.
...
The tracking system of the LHCb detector consists of the following components
(sorted based on the proximity from the $pp$ interaction point):

\begin{itemize}
    \item VErtex LOcator: The VErtex LOcator (VELO) is a compact multi-layered
        silicon-strip detector placed closest to the $pp$ collision point.
        Each layer of the VELO provides the radial and azimuthal angular
        position of the track.
        Combining the positional information from all layers,
        a resolution of about 4~$\mu$m at best is achieved
        \cite{Aaij_2014}.
\end{itemize}
