...
% luminosity run 1+2
At the designed LHCb luminosity, multiple $pp$ collisions happen within the
same bunch crossing (pile up)
which greatly complicate \bbbar production and event reconstruction because
the event\footnote{
