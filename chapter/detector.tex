...
\begin{itemize}
    ...
    \item Tracker Turicensis (TT):
        ...
        % FIXME: We don't talk about TT that much
        % The author actively participated in the design and construction of the
        % Upstream Tracker (UT) which replaces TT.
        % More technical details for both TT and UT will be provided in
        % \cref{ref:ut}
