...
\begin{itemize}
    \item VErtex LOcator:
        ...
        Each layer of VELO,
        made of two silicon half disks with a minimum pitch\footnote{
    ...
    \item Tracker Turicensis:
        ...
        which replaces TT.
        More technical details for both subdetectors will be provided in
        \cref{part:ut}.

    \item T-stations and Outer Tracker:
\end{itemize}
