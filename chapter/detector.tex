...
%%%%
To reduce the readout bandwidth from 40~MHz, the LHC bunch crossing frequency,
to 1~MHz,
the hardware trigger,
referred as Level-0 (L0) triggers,
reconstruct transverse energy $E_T$ and momentum $p_T$ in real time and select
events with large $E_T$ or $p_T$,
...
The HLT triggers reduce the bandwidth to about 2~kHz
\cite{The_LHCb_Collaboration_2008}.
...
\begin{itemize}
    \item Pile-up system:
        The pile-up system distinguishes single and multiple $pp$ interactions
        in a bunch crossing,
        with the help of four silicon sensors with the same type as in the VELO
        to measure the radial positions of tracks.
    ...
    \item Calorimeter trigger system:
        ...
        estimated number of tracks (charged particles) in the events.
    ...
    \item Muon trigger system:
        ...
        The L0 muon triggers requires either the largest muon \pt exceeds
        1.8~GeV or product of two largest muon \pt exceeds 2.25~GeV$^2$
