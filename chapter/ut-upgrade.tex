...
Data Control Board (DCB), shown in \cref{fig:dcb-prod},
...
One DCB admits 1 electro-optical transceiver and up to 3 transmitter modules
named Versatile link which GBLD is a part of the module responsible for
optical data transmission;
each of them is installed in a separate optical mezzanine before mounted to a
DCB.
