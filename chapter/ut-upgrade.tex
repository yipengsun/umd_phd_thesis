...
clock frequency with a phase difference,
which implies that as SALT start transmitting data,
the GBTx is \emph{not guaranteed} to have stable edge in clock;
...
the GBTx is in a rising or a falling edge of the clock, in which case
