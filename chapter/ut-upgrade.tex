...
readout, serration of digitized readout, and distribution of control commands.
The DCB,
...
the configurability of DCB (\cref{dcb-jumper,dcb-i2c}),
...
\begin{itemize}
    ...
    \item \textbf{GBT-SCA}:
        ...
        namely SPI, I2C, JTAG, and GPIO, to the GBT data frame
        \cite{sca_manual}.

        For a single GBT data frame operating in the
        Forward Error Correction (FEC) mode,
        a range of address is reserved for the slow control commands which can
        be decoded/encoded by the SCA.
\end{itemize}
