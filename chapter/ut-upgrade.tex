...
%
% 5. In your online system review slides (MTobin_UT_Review_14112022.pdf), it is
% claimed that many TELL40 and SOL40 are virtual machines.
% How does it work? I can imagine for SOL40 one can do a PCIE pass-thru so that
% multiple PCIe40 can be plugged into a single physical machine so that one
% physical machine can act as multiple SOL40.
% For TELL40 however, it requires 2 additional GPUs which also need to be passed
% to the VM. Is it true that one physical machine can also host MULTIPLE TELL40s,
% which seem to be very resource-hungry?
%
% 6. Out of curiosity, what kind of virtualization software does the LHCb use?
% XVM or KVM, or something else?
