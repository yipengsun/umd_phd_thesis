...
a stave is a long strip of flexible cable with sensors and hybrid readout
wire-bonded on both sides.
Shown in \cref{fig:stave}, the sensors are mounted with an overlap to ensure
coverage.
...
more specifically, the four sensors immediately surrounding the pipe has
