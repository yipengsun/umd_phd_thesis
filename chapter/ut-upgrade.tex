...
sever.
The \dim protocol communication interface is defined as the following:
...
\begin{figure}[!htb]
    ...
    \caption{
        With the WinCC OA UI, configuring 6 GBTxes requires the author
        to change the ``Address'' field from 1 to 6 manually.
    }
...
It becomes possible to identify these services in the JCOP source code,
