...
analysis.
A generic selection procedure involves two parts: online and offline selection.
The first online selection are a composition of
pre-defined triggers and additional cuts provided by the LHCb experiment;
...
these are discussed in \cref{ref:selection:data} and
...
\subsection{Nominal data sample}
