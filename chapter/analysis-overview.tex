...
as indicated in the decay descriptors and parton level diagrams
(\cref{fig:decay-diagrams}),
because the LHCb detector is not well-suited for neutral particle
reconstruction.

\begin{figure}[!htb]
    \caption{Parton level diagrams for the chosen decay modes.}
