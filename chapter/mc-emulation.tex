...
the emulated \smalltt{Hlt1TrackMVA} triggers well-reproduce the FullSim
efficiencies in all fit variables,
whereas for \smalltt{Hlt1TwoTrackMVA} there is a roughly constant efficiency
...
The selected \B is required to be TOS for \smalltt{Hlt2XcMuXForTauB2XcMu}.
...
Most of the PID efficiencies are obtained with \pidcalib,
